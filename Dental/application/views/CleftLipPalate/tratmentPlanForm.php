...
<form id="cleftLipTreatmentPlanForm">
  <div class="form-group">
    <label for="address">Plan</label>
    <textarea class="form-control" rows="6" id="treatplan" name='treatplan' value="<?php echo set_value('treatplan'); ?>"></textarea>
    <label > <span style="color:#d9534f;"><?php echo form_error('treatplan'); ?></span></label>
    <script src="<?php echo base_url('assest/editor/ckeditor/ckeditor/ckeditor.js'); ?>"></script>
    <script type="text/javascript">
            CKEDITOR.replace( 'treatplan', {
    ...
    <div class="col-sm-12 text-center">
          <button type="button" class="btn btn-primary" onclick="CKEDITOR.instances.treatplan.updateElement();saveCleftLipTreatmentPlan();"><i class="fa fa-save"></i> Save </button>
