  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-sm-12" >
                   <form id ='upteethform' method=POST action="<?php echo base_url('index.php/TraumaTreatment/updatemedicaldetails')?>">        
                                Teeth<br>
                                <button  class="btn btn-default col-sm-1" id='upbtnt15' value='1' onclick='getteeth(this.id); return false;'>15</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt14' value='2' onclick='getteeth(this.id); return false;'>14</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt13' value='3' onclick='getteeth(this.id); return false;'>13</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt12' value='4' onclick='getteeth(this.id); return false;'>12</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt11' value='5' onclick='getteeth(this.id); return false;'>11</button>
                                ...
                                <br><br>
                                <button  class="btn btn-default col-sm-1" id='upbtnt45' value='11' onclick='getteeth(this.id); return false;'>44</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt44' value='12' onclick='getteeth(this.id); return false;'>45</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt43' value='13' onclick='getteeth(this.id); return false;'>43</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt42' value='14' onclick='getteeth(this.id); return false;'>42</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt41' value='15' onclick='getteeth(this.id); return false;'>41</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt31' value='16' onclick='getteeth(this.id); return false;'>31</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt32' value='17' onclick='getteeth(this.id); return false;'>32</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt33' value='18' onclick='getteeth(this.id); return false;'>33</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt34' value='19' onclick='getteeth(this.id); return false;'>34</button>
                                <button  class="btn btn-default col-sm-1" id='upbtnt35' value='20' onclick='getteeth(this.id); return false;'>35</button>
                                <br>
...
<!-- Modal -->
<div id="setteeth" class="modal fade" role="dialog">
