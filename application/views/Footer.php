            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            <li><a href="<?php echo base_url('assest/'); ?>category.html">T-shirts</a>
                            </li>
                            <li><a href="<?php echo base_url('assest/'); ?>category.html">Shirts</a>
                            </li>
                            <li><a href="<?php echo base_url('assest/'); ?>category.html">Accessories</a>
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo base_url('assest/'); ?>category.html">Skirts</a>
                            </li>
                            <li><a href="<?php echo base_url('assest/'); ?>category.html">Pants</a>
                            </li>
                            <li><a href="<?php echo base_url('assest/'); ?>category.html">Accessories</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <a href="<?php echo base_url('assest/'); ?>contact.html">Go to contact page</a>
			    ...
			    <button class="btn btn-default" type="button">Subscribe!</button>
                        ...
                        <p class="social">
                            <a href="<?php echo base_url('assest/'); ?>#" class="facebook external" data-animate-hover="shake"><i class="fa fa-facebook"></i></a>
                            <a href="<?php echo base_url('assest/'); ?>#" class="twitter external" data-animate-hover="shake"><i class="fa fa-twitter"></i></a>
                            <a href="<?php echo base_url('assest/'); ?>#" class="instagram external" data-animate-hover="shake"><i class="fa fa-instagram"></i></a>
                            <a href="<?php echo base_url('assest/'); ?>#" class="gplus external" data-animate-hover="shake"><i class="fa fa-google-plus"></i></a>
                            <a href="<?php echo base_url('assest/'); ?>#" class="email external" data-animate-hover="shake"><i class="fa fa-envelope"></i></a>
                        </p>
